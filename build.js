...
var State = /*#__PURE__*/function () {
  function State(update, host) {
    ...
    _defineProperty(this, hookSymbol, void 0);

    _defineProperty(this, effectsSymbol, void 0);

    _defineProperty(this, layoutEffectsSymbol, void 0);
...
var BaseScheduler = /*#__PURE__*/function () {
  function BaseScheduler(renderer, host) {
    ...
    _defineProperty(this, phaseSymbol, void 0);

    _defineProperty(this, "_updateQueued", void 0);
...
function makeComponent(render) {
  var Scheduler = /*#__PURE__*/function (_BaseScheduler) {
    ...
    function Scheduler(renderer, frag, host) {
      ...
      _defineProperty(_assertThisInitialized(_this), "frag", void 0);
  ...
  function component(renderer, baseElementOrOptions, options) {
    ...
    var Element = /*#__PURE__*/function (_BaseElement) {
      ...
      function Element() {
        ...
        _defineProperty(_assertThisInitialized(_this2), "_scheduler", void 0);
...
var Hook = /*#__PURE__*/_createClass(function Hook(id, state) {
...
function createEffect(setEffects) {
  return hook( /*#__PURE__*/function (_Hook) {
    _inherits(_class2, _Hook);

    var _super = _createSuper(_class2);

    function _class2(id, state, ignored1, ignored2) {
      var _this;
      ...
      _defineProperty(_assertThisInitialized(_this), "lastValues", void 0);

      _defineProperty(_assertThisInitialized(_this), "values", void 0);

      _defineProperty(_assertThisInitialized(_this), "_teardown", void 0);
...
var useContext = hook( /*#__PURE__*/function (_Hook) {
  ...
  function _class2(id, state, _) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_ranEffect", void 0);
  ...
  _createClass(_class2, [{
    ...
    value: function _subscribe(Context) {
      ...
      var _detail$unsubscribe = detail.unsubscribe,
          unsubscribe = _detail$unsubscribe === void 0 ? null : _detail$unsubscribe,
          value = detail.value;
...
hook( /*#__PURE__*/function (_Hook) {
  _inherits(_class2, _Hook);

  var _super = _createSuper(_class2);

  function _class2(id, state, fn, values) {
    var _this;
...
var useState = hook( /*#__PURE__*/function (_Hook) {
  ...
  function _class2(id, state, initialValue) {
    var _this;
...
hook( /*#__PURE__*/function (_Hook) {
  ...
  function _class2(id, state, _, initialState, init) {
    var _this;
